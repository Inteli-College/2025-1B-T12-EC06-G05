...
<div style={{margin: 25}}>
    <div style={{textAlign: 'center'}}>
        <img src={require("../../../../static/img/BMC-certo.png").default} style={{width: 800}} alt="Business Model Canvas" />
        <br />
    </div>
</div>
...
- Suporte técnico durante o uso da plataforma
- Coleta de feedback para melhorias contínuas
- Comunicação regular sobre atualizações e progresso do projeto


## 1.6 Canais

- Reuniões e apresentações técnicas com o IPT
- E-mails institucionais e entrega de relatórios
...
- Assinatura Mensal/Anual: Com diferentes planos baseados no volume de uso (número de inspeções, armazenamento de dados, etc.).
- Licenciamento por Projeto: Cobrança por projeto ou por número de imagens analisadas, ideal para clientes com demandas pontuais.
- Customização da Plataforma: Desenvolvimento de funcionalidades específicas ou integrações para atender às necessidades de grandes clientes.
