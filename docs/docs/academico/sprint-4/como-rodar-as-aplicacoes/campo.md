...
&emsp;Neste documento iremos demonstrar como você pode inicializar a aplicação de campo:
...
#### Aqui vamos instalar todos as dependências da parte do front-end.
...
&emsp;Seguindo os passos acima, você terá toda a aplicação de campo funcionando. Em caso de dúvidas, verifique se todos os passos foram seguidos corretamente e se as dependências estão instaladas nas versões indicadas.